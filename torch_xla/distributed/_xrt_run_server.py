"""
This script is for starting the pjrt_server. It also polls the PID and
checks if it exist. It would kill the server, when the process whose
PID it was tracking dies.
NOTE: This script should be used only by pjrt_init.py and not anyone else.
"""
import os
import argparse
import psutil
...
if __name__ == '__main__':
  ...
  server_process = multiprocessing.Process(
      target=torch_xla._XLAC._run_pjrt_local_service, args=(int(args.port),))
