...
def while_loop(cond_fn, body_fn, carried_inputs, additional_inputs=None):
  ...
  # return _xla_while_loop_wrapper_reorder(cond_fn, body_fn, carried_inputs, additional_inputs)

  # bn_layer = True
  # if bn_layer:
  #   return _xla_while_loop_warpper_bn(cond_fn, body_fn, carried_inputs, additional_inputs)
  # else:
  #   return _xla_while_loop_wrapper_reorder(cond_fn, body_fn, carried_inputs, additional_inputs)
...
def _xla_while_loop_wrapper(cond_fn, body_fn, carried_inputs, additional_inputs=None, bn_additional_inputs=[]):
  ...
  # return _xla_while_loop_reorder(cond_fn, new_body_fn, carried_inputs, additional_inputs, bn_additional_inputs)
  # return _xla_while_loop_get_xla_computation(cond_fn, new_body_fn, carried_inputs, additional_inputs, bn_additional_inputs)

def _xla_while_loop_wrapper_reorder(cond_fn, body_fn, carried_inputs, additional_inputs=None, bn_additional_inputs=[]):
  ...
  def new_body_fn(*carried_inputs):
    ...
    if additional_inputs and (bn_additional_inputs != []):
      ...
      print("arrive here 2 !!!")
      # res = [res[0], ] + list(additional_inputs) + res[1:]
      res = res[:-1] + list(additional_inputs) + res[-1:]
    else:
      print("arrive here 3 !!!")
      res = res
    return res
...
def _xla_while_loop_warpper_bn(cond_fn, body_fn, carried_inputs, additional_inputs=None, bn_additional_inputs=[]):
  ...
  # return _xla_while_loop(cond_fn, new_body_fn, carried_inputs, additional_inputs, bn_additional_inputs)
  return _xla_while_loop_bn(cond_fn, new_body_fn, carried_inputs, additional_inputs, bn_additional_inputs)
  # return _xla_while_loop_get_xla_computation(cond_fn, new_body_fn, carried_inputs, additional_inputs, bn_additional_inputs)
...
def _xla_while_loop(cond_fn, body_fn, carried_inputs, additional_inputs=None, bn_additional_inputs=[]):
  ...
  cond_computation = xb.computation_from_module_proto("condcomputation",
                                                      cond_hlo)
  # cond_computation = torch_xla._XLAC._get_xla_computation(list(cond_result), [], True) # try try try
...
def _xla_while_loop_reorder(cond_fn, body_fn, carried_inputs, additional_inputs=None, bn_additional_inputs=[]):
...
def _xla_while_loop_bn(cond_fn, body_fn, carried_inputs, additional_inputs=None, bn_additional_inputs=[]):
  ...
  if bn_additional_inputs:
    for bn_additional_input in bn_additional_inputs:
      device = bn_additional_input.device
      fake_additiona_args.append(
          torch.randint(
              10, bn_additional_input.size(),
              dtype=bn_additional_input.dtype).to(device))

  # === check bn layer
  # _has_potential_branch_input_mutation(fn, unwrapped_inputs, pre_dispatch=False):
  ...
  body_result = body_fn(carried_inputs[0], *fake_carried_inputs[1:], *additional_inputs, *bn_additional_inputs) # passed May version
  # body_result = body_fn(*carried_inputs, *additional_inputs) # try try try
  # body_result = body_fn(*additional_inputs, *carried_inputs)
  body_ctx = torch_xla._XLAC.lowering.LoweringContext()
  body_ctx.set_name_string("bodyctx")
  ...
  #  ====== cond_fn ======
  cond_result = cond_fn(*carried_inputs, *additional_inputs, *bn_additional_inputs)
  cond_ctx = torch_xla._XLAC.lowering.LoweringContext()
  cond_ctx.set_name_string("condctx")
  ...
  # total_inputs = tuple([iter_value,]) + tuple(additional_inputs) + tuple(bn_additional_inputs) + tuple(input_and_outputs_value)
  total_inputs = tuple(iter_value) + tuple(additional_inputs) + tuple(bn_additional_inputs) + tuple(input_and_outputs_value)
  # print("type total_inputs: ", type(total_inputs))
  ...
  if type(total_inputs) is tuple:
    ...
    shapes = xb.tensor_shape((total_inputs))
  # shapes = xb.tensor_shape(list(total_inputs))
