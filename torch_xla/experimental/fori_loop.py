...
def _xla_while_loop(cond_fn, body_fn, operands):
  ...
  for shape in shapes:
    ...
    single_tuple = xb.Op.tuple(p) # [p])
    params.append(single_tuple) # p) # single_tuple)
  ...
  result = torch_xla._XLAC._xla_user_computation('xla::_op_test_while', params, computation)
