...
def mark_sharding(
    ...
    partition_spec: Tuple[Union[Tuple, int, str, None]], shard_fn = torch_xla._XLAC._xla_mark_sharding) -> XLAShardedTensor:
  """
  ...
  if isinstance(t, XLAShardedTensor):
    shard_fn(t.global_tensor, op_sharding)
    return t
  shard_fn(t, op_sharding)
