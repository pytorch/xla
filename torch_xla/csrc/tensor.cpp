...
c10::SymNode XLASymNodeImpl::eq(const c10::SymNode& other) {
  ...
  std::cout << "xw32, file=" << __FILE__ << ", line=" << __LINE__
            ...
            << ": this.get_backtrace_when_created()="
            << get_backtrace_when_created() << std::endl;
  std::cout << "xw32, file=" << __FILE__ << ", line=" << __LINE__
            << "function=" << __FUNCTION__
            << ": p_other->get_backtrace_when_created()="
            << p_other->get_backtrace_when_created() << std::endl;

  std::cout << "xw32, file=" << __FILE__ << ", line=" << __LINE__
            << "function=" << __FUNCTION__
            << ": this.get_xlaTensorImplAddr()=" << get_xlaTensorImplAddr()
            << std::endl;
  std::cout << "xw32, file=" << __FILE__ << ", line=" << __LINE__
            << "function=" << __FUNCTION__
            << ": p_other->get_xlaTensorImplAddr()="
            << p_other->get_xlaTensorImplAddr() << std::endl;
