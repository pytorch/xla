...
// torch/xla computation. It wraps a torch_xla::runtime::ComputationClient::Computation.
// 3. torch_xla::runtime::ComputationClient::Computation represent a computation from the
...
// torch_xla::runtime::ComputationClient::Computation and contains a handle to represent the
// compiled program.
...
// torch_xla::runtime::ComputationClient::Computation.
// torch_xla::runtime::ComputationClient::Computation::devices_ would be empty.
...
// around a torch_xla::runtime::ComputationClient::Computation.
...
class Computation : public torch::lazy::Computation {
 public:
  ...
  Computation(std::shared_ptr<torch_xla::runtime::ComputationClient::Computation>
  ...
  std::shared_ptr<torch_xla::runtime::ComputationClient::Computation> client_computation()
      const {
 ...
 private:
  std::string name_;
  std::shared_ptr<torch_xla::runtime::ComputationClient::Computation> xla_client_computation_;
