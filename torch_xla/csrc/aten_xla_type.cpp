...
at::Tensor _adaptive_avg_pool3d_backward(
...
at::Tensor _copy_from(const at::Tensor& self,
...
at::Tensor _s_where(const at::Tensor& condition,
                                 const at::Tensor& self,
                                 const at::Tensor& other) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor addcdiv(const at::Tensor& self,
...
at::Tensor addcmul(const at::Tensor& self,
                                const at::Tensor& tensor1,
                                const at::Tensor& tensor2,
                                const at::Scalar& value) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor& arange_out(const at::Scalar& start,
                                    const at::Scalar& end,
...
at::Tensor argmin(const at::Tensor& self,
                               c10::optional<int64_t> dim, bool keepdim) {
  XLA_FN_COUNTER("xla::");
  return dim ? bridge::AtenFromXlaTensor(
...
at::Tensor avg_pool2d(const at::Tensor& self,
...
at::Tensor avg_pool3d(const at::Tensor& self,
                                   at::IntArrayRef kernel_size,
                                   at::IntArrayRef stride,
                                   at::IntArrayRef padding, bool ceil_mode,
                                   bool count_include_pad,
...
at::Tensor baddbmm(const at::Tensor& self,
...
at::Tensor& bitwise_and_out(const at::Tensor& self,
                                         const at::Scalar& other,
                                         at::Tensor& out) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor& bitwise_not_out(const at::Tensor& self,
                                         at::Tensor& out) {
  XLA_FN_COUNTER("xla::");
  XLATensor out_tensor = bridge::GetXlaTensor(out);
  XLATensor self_tensor = bridge::GetXlaTensor(self);
...
at::Tensor& bitwise_or_out(const at::Tensor& self,
                                        const at::Scalar& other,
                                        at::Tensor& out) {
  XLA_FN_COUNTER("xla::");
  CheckBinaryOpTypePromotion(out, self, other);
...
at::Tensor& bitwise_xor_out(const at::Tensor& self,
                                         const at::Scalar& other,
                                         at::Tensor& out) {
  XLA_FN_COUNTER("xla::");
  CheckBinaryOpTypePromotion(out, self, other);
...
at::Tensor clamp(const at::Tensor& self,
...
at::Tensor& clamp_(at::Tensor& self,
                                const c10::optional<at::Scalar>& min,
                                const c10::optional<at::Scalar>& max) {
  XLA_FN_COUNTER("xla::");
  XLATensor self_tensor = bridge::GetXlaTensor(self);
...
at::Tensor clamp_max(const at::Tensor& self,
                                  const at::Scalar& max) {
  XLA_FN_COUNTER("xla::");
  return bridge::AtenFromXlaTensor(
...
at::Tensor& clamp_max_out(const at::Tensor& self,
...
at::Tensor clamp_min(const at::Tensor& self,
                                  const at::Scalar& min) {
  XLA_FN_COUNTER("xla::");
  return bridge::AtenFromXlaTensor(
...
at::Tensor& clamp_min_out(const at::Tensor& self,
...
at::Tensor constant_pad_nd(const at::Tensor& self,
                                        at::IntArrayRef pad,
                                        const at::Scalar& value) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor diagonal(const at::Tensor& self, int64_t offset,
...
at::Tensor elu_backward(const at::Tensor& grad_output,
                                     const at::Scalar& alpha,
                                     const at::Scalar& scale,
...
at::Tensor empty_strided(at::IntArrayRef size,
                                      at::IntArrayRef stride,
                                      c10::optional<at::ScalarType> dtype,
...
at::Tensor gelu_backward(const at::Tensor& grad,
                                      const at::Tensor& self) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor hardtanh(const at::Tensor& self,
...
at::Tensor& index_add_(at::Tensor& self, int64_t dim,
                                    const at::Tensor& index,
...
std::tuple<at::Tensor, at::Tensor> kthvalue(const at::Tensor& self,
...
at::Tensor& masked_scatter_(at::Tensor& self,
...
at::Tensor masked_select(const at::Tensor& self,
                                      const at::Tensor& mask) {
  XLA_FN_COUNTER("xla::");
  XLATensor self_tensor = bridge::GetXlaTensor(self);
...
std::tuple<at::Tensor, at::Tensor> max(const at::Tensor& self,
...
at::Tensor maximum(const at::Tensor& self,
                                const at::Tensor& other) {
  XLA_FN_COUNTER("xla::");
  return DoBinaryOp(self, other,
                    [&](const XLATensor& xself, const XLATensor& xother,
...
at::Tensor max_pool2d(const at::Tensor& self,
                                   at::IntArrayRef kernel_size,
                                   at::IntArrayRef stride,
...
at::Tensor max_pool3d(const at::Tensor& self,
                                   at::IntArrayRef kernel_size,
                                   at::IntArrayRef stride,
                                   at::IntArrayRef padding,
                                   at::IntArrayRef dilation, bool ceil_mode) {
...
std::tuple<at::Tensor, at::Tensor> min(const at::Tensor& self,
                                                    int64_t dim, bool keepdim) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor minimum(const at::Tensor& self,
                                const at::Tensor& other) {
  XLA_FN_COUNTER("xla::");
  return DoBinaryOp(self, other,
                    [&](const XLATensor& xself, const XLATensor& xother,
...
at::Tensor mse_loss(const at::Tensor& self,
                                 const at::Tensor& target, int64_t reduction) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor pow(const at::Scalar& self,
                            const at::Tensor& exponent) {
  XLA_FN_COUNTER("xla::");
  // xla::Pow() doesn't support integer types.
...
at::Tensor prod(const at::Tensor& self,
                             c10::optional<at::ScalarType> dtype) {
  XLA_FN_COUNTER("xla::");
  XLATensor self_tensor = bridge::GetXlaTensor(self);
...
at::Tensor& random_(at::Tensor& self, int64_t from,
...
at::Tensor& random_(at::Tensor& self,
                                 c10::optional<at::Generator> generator) {
  XLA_FN_COUNTER("xla::");
  if (generator.has_value() && generator->defined()) {
...
at::Tensor replication_pad2d(const at::Tensor& self,
                                          at::IntArrayRef padding) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor& scatter_(at::Tensor& self, int64_t dim,
                                  const at::Tensor& index,
                                  const at::Tensor& src) {
  XLA_FN_COUNTER("xla::");
  XLATensor self_tensor = bridge::GetXlaTensor(self);
...
std::vector<at::Tensor> split(const at::Tensor& self,
...
at::Tensor std(const at::Tensor& self, at::IntArrayRef dim,
...
at::Tensor threshold(const at::Tensor& self,
                                  const at::Scalar& threshold,
                                  const at::Scalar& value) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor& threshold_(at::Tensor& self,
                                    const at::Scalar& threshold,
                                    const at::Scalar& value) {
  XLA_FN_COUNTER("xla::");
  XLATensor self_tensor = bridge::GetXlaTensor(self);
...
std::tuple<at::Tensor, at::Tensor> topk(const at::Tensor& self,
                                                     int64_t k, int64_t dim,
                                                     bool largest,
                                                     bool sorted) {
  XLA_FN_COUNTER("xla::");
...
at::Tensor var(const at::Tensor& self, at::IntArrayRef dim,
                            bool unbiased, bool keepdim) {
  XLA_FN_COUNTER("xla::");
  XLATensor self_tensor = bridge::GetXlaTensor(self);
  return bridge::AtenFromXlaTensor(
