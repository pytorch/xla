...
std::vector<int64_t> XlaHelpers::DropDimensions(
    absl::Span<const int64_t> sizes,
...
int64_t XlaHelpers::GetCanonicalDimensionIndex(int64_t dim,
                                                    int64_t rank) {
...
std::vector<int64_t> XlaHelpers::GetCanonicalDimensionIndices(
...
int64_t XlaHelpers::GetCanonicalPosition(
...
xla::XlaOp XlaHelpers::ReshapeToRank(xla::XlaOp input,
  ...
  std::vector<int64_t> dimensions(expected_rank - offset - shape.rank(),
                                       1);
...
std::vector<int64_t> XlaHelpers::MakeTransposePermutation(
    int64_t dim0, int64_t dim1, int64_t rank) {
  int64_t canonical_dim0 = GetCanonicalDimensionIndex(dim0, rank);
  int64_t canonical_dim1 = GetCanonicalDimensionIndex(dim1, rank);
  auto permute_dims = xla::util::Iota<int64_t>(rank);
...
std::vector<int64_t> XlaHelpers::GetPromotedShape(
