...
Computation::Computation(
    std::shared_ptr<torch_xla::runtime::ComputationClient::Computation> xla_client_computation)
    : name_(""), hash_(0) {
...
std::shared_ptr<torch_xla::runtime::ComputationClient::Computation> UnwrapClientComputation(
