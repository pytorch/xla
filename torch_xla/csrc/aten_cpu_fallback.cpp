...
// _cpu_fallback_counters to remain as torch_xla::runtime::metrics::Counter to support
// torch_xla::runtime::metrics::CreatePerformanceReport(). For more information, see NOTE:
...
void xla_cpu_fallback(const c10::OperatorHandle& op, torch::jit::Stack* stack) {
  ...
  if (_cpu_fallback_counters.find(name) == _cpu_fallback_counters.end()) {
    _cpu_fallback_counters[name] = new ::torch_xla::runtime::metrics::Counter(name);
  }
