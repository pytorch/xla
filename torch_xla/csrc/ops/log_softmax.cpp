...
xla::XlaOp LowerLogSoftmax(const xla::XlaOp& input,
                    xla::int64 dim,
                     c10::optional<at::ScalarType> dtype) {
  xla::XlaOp casted_input = CastToScalarType(input, dtype);
  return BuildLogSoftmax(casted_input, dim);
}
...
LogSoftmax::LogSoftmax(const Value& input, xla::int64 dim, c10::optional<at::ScalarType> dtype)
