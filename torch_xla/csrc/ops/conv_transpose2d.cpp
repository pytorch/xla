...
ConvTranspose2d::ConvTranspose2d(const Value& input, const Value& weight,
    ...
    : Node(ir::OpKind(at::aten::slow_conv_transpose2d), {input, weight, bias},
...
NodePtr ConvTranspose2d::Clone(OpList operands) const {
  return operands.size() == 3
             ? MakeNode<ConvTranspose2d>(operands.at(0), operands.at(1),
