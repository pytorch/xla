...
inline NodePtr GenericOp(
  ...
  return torch_xla::ir::MakeNode<Generic>(std::move(op), operands, std::move(shape),
...
inline NodePtr GenericOp(OpKind op, xla::Shape shape, Generic::LowerFn lower_fn,
  ...
  return torch_xla::ir::MakeNode<Generic>(std::move(op), std::move(shape), std::move(lower_fn),
