...
NodePtr ReciprocalOp(const Value& input) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::reciprocal), {input}, input.shape(),
                   std::move(lower_fn));
}
...
NodePtr Prelu(const Value& input, const Value& weight) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::prelu), {input, weight}, input.shape(),
                   std::move(lower_fn));
}
...
NodePtr HardSigmoid(const Value& input) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::hardsigmoid), {input}, input.shape(),
                   std::move(lower_fn));
}
...
NodePtr HardSigmoidBackward(const Value& grad_output, const Value& input) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::hardsigmoid_backward), {grad_output, input},
...
NodePtr SiLUBackward(const Value& grad_output, const Value& input) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::silu_backward), {grad_output, input},
                   [&]() {
...
NodePtr Sigmoid(const Value& input) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::sigmoid), {input}, input.shape(),
                   std::move(lower_fn));
}
...
NodePtr Clamp(const Value& input, const Value& min, const Value& max) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::clamp), {input, min, max}, input.shape(),
                   std::move(lower_fn));
}
...
NodePtr AdaptiveMaxPool2dBackward(const Value& grad_output,
  ...
  return GenericOp(
      torch::lazy::OpKind(at::aten::adaptive_max_pool2d_backward), {grad_output, input},
      [&]() {
...
NodePtr AdaptiveAvgPool3dBackward(const Value& grad_output,
  ...
  return GenericOp(
      torch::lazy::OpKind(at::aten::adaptive_avg_pool3d_backward), {grad_output, input},
      [&]() {
        return InferOutputShape({grad_output.shape(), input.shape()},
                                lower_for_shape_fn);
      },
...
NodePtr AdaptiveAvgPool2dBackward(const Value& grad_output,
  ...
  return GenericOp(
      torch::lazy::OpKind(at::aten::adaptive_avg_pool2d_backward), {grad_output, input},
      [&]() {
        return InferOutputShape({grad_output.shape(), input.shape()},
                                lower_for_shape_fn);
      },
...
NodePtr Where(const Value& condition, const Value& input, const Value& other) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::where), {condition, input, other},
                   input.shape(), std::move(lower_fn));
}
...
NodePtr TanhGelu(const Value& input) {
  ...
  NodePtr three = ScalarOp(3, shape);
  NodePtr one = ScalarOp(1, shape);
  NodePtr half = ScalarOp(0.5, shape);
...
NodePtr Inverse(const Value& input) {
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::inverse), {input}, input.shape(),
                   std::move(lower_fn));
}
...
NodePtr NanToNum(const Value& input, const Value& nan, const Value& posinf,
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::nan_to_num), {input, nan, posinf, neginf},
                   input.shape(), std::move(lower_fn));
}
...
NodePtr Softplus(const Value& input, const Value& beta,
  ...
  return GenericOp(torch::lazy::OpKind(at::aten::softplus), {input, beta, threshold},
                   input.shape(), std::move(lower_fn));
}
