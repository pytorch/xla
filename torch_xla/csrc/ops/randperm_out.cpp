...
RandpermOut::RandpermOut(int64_t n)
    : XlaNode(torch::lazy::OpKind(at::aten::randperm), torch::lazy::OpList(),
              xla::ShapeUtil::MakeShape(xla::S64, {n}), // TODO: should I use U64 or U32 or others? How can I determine that?
...
std::string RandpermOut::ToString() const {
  std::cout << "xw32 inside randperm_out.cpp RandpermOut::ToString" << std::endl;
  std::stringstream ss;
