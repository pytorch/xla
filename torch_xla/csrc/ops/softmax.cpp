...
xla::XlaOp LowerSoftmax(const xla::XlaOp& input,
                    xla::int64 dim,
                     c10::optional<at::ScalarType> dtype) {
  xla::XlaOp casted_input = CastToScalarType(input, dtype);
  return BuildSoftmax(casted_input, dim);
}
...
Softmax::Softmax(const Value& input, xla::int64 dim, c10::optional<at::ScalarType> dtype)
