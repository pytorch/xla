...
class ConvTranspose2d : public Node {
 public:
  ConvTranspose2d(const Value& input, const Value& weight, const Value& bias,
                  std::vector<xla::int64> stride,
                  std::vector<xla::int64> padding);

  ConvTranspose2d(const Value& input, const Value& weight,
                  std::vector<xla::int64> stride,
                  std::vector<xla::int64> padding);
