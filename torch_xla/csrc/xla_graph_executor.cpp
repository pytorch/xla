...
void XLAGraphExecutor::SetEnableParameterAliasing(bool enable_param_aliasing) {
  DeviceContextArena::Get()->SetEnableParameterAliasing(enable_param_aliasing);
}

bool XLAGraphExecutor::GetEnableParameterAliasing() {
  return DeviceContextArena::Get()->GetEnableParameterAliasing();
}

void XLAGraphExecutor::SetAliasWithBufferDonorConfig(
    bool enable_user_config_alias) {
  DeviceContextArena::Get()->SetAliasWithBufferDonorConfig(
