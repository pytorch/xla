...
// TODO @wonjoo Remove
// inline std::ostream& operator<<(std::ostream& stream, const torch::lazy::OpKind& op) {
//   stream << op.ToString();
//   return stream;
// }
...
class Node {
 public:
  ...
  // generates.
  Node(torch::lazy::OpKind op, OpList operands, xla::Shape shape, size_t num_outputs = 1,
  ...
  Node(torch::lazy::OpKind op, OpList operands, const std::function<xla::Shape()>& shape_fn,
 ...
 private:
  ...
  static torch::lazy::hash_t GetOpHash(torch::lazy::OpKind op, const xla::Shape& shape,
                                       torch::lazy::hash_t hash_seed);
