...
XLATensorPtr addcdiv(const XLATensorPtr& input,
...
XLATensorPtr addcmul(const XLATensorPtr& input,
                            const at::Scalar& value,
                            const XLATensorPtr& tensor1,
                            const XLATensorPtr& tensor2);
...
XLATensorPtr amax(const XLATensorPtr& input,
                        std::vector<int64_t> dimensions,
                        bool keep_reduced_dimensions);

XLATensorPtr amin(const XLATensorPtr& input,
                        std::vector<int64_t> dimensions,
                        bool keep_reduced_dimensions);
...
XLATensorPtr hardshrink(const XLATensorPtr& input,
...
XLATensorPtr randperm(int64_t n,
                            const torch::lazy::BackendDevice& device,
                            at::ScalarType scalar_type);
...
XLATensorPtr silu_backward(XLATensorPtr& grad_output,
                                XLATensorPtr& input);
...
XLATensorPtr softshrink(const XLATensorPtr& input,
                                const at::Scalar& lambda);
...
XLATensorPtr take(const XLATensorPtr& input,
                        const XLATensorPtr& index);
