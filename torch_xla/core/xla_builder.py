...
class Op(object):
  ...
  def while_loop(self, condition_computation, body_computation):
    ...
    condition_computation_hlo = xb.get_computation_hlo(condition_computation)
    print("condition_computation hlo: ", condition_computation_hlo)

    print("body_computation type: ", type(body_computation))
    body_computation_hlo = xb.get_computation_hlo(body_computation)
    print("body_computation hlo: ", body_computation_hlo)
