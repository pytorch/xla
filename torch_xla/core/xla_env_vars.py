...
PJRT_LOCAL_RANK = 'PJRT_LOCAL_RANK'
PJRT_LOCAL_WORLD_SIZE = 'PJRT_LOCAL_WORLD_SIZE'
...
PJRT_WORLD_SIZE = 'PJRT_WORLD_SIZE'
PJRT_RANK = 'PJRT_RANK'
PJRT_GROUP_RANK = 'PJRT_GROUP_RANK'
LOCAL_RANK = 'LOCAL_RANK'

PJRT_DIST_SERVICE_ADDR_DEFAULT = '127.0.0.1:28547'
