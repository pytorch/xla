MP_DEVICE = 'PJRT_MULTI_PROCESSING_DEVICE'
LOCAL_WORKER = 'PJRT_LOCAL_WORKER'
TPU_CONFIG = 'PJRT_TPU_CONFIG'
TPUVM_MODE = 'TPUVM_MODE'
SERVICE_ADDRESS = 'PJRT_MESH_SERVICE_ADDRESS'
DEVICE_MAP = 'PJRT_DEVICE_MAP'
WORKERS = 'PJRT_WORKERS'
LOCAL_ORDINAL = 'PJRT_SHARD_LOCAL_ORDINAL'
ORDINAL = 'PJRT_SHARD_ORDINAL'
WORLD_SIZE = 'PJRT_SHARD_WORLD_SIZE'
HOST_WORLD_SIZE = 'PJRT_HOST_WORLD_SIZE'
HOST_ORDINAL = 'PJRT_HOST_ORDINAL'
TORCH_DIST_METHOD = 'PJRT_TORCH_DIST_METHOD'
TORCH_DIST_ROOT = 'PJRT_TORCH_DIST_ROOT'
