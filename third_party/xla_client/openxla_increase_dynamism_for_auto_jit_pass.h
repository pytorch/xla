...
#ifndef XLA_CLIENT_INCREASE_DYNAMISM_FOR_AUTO_JIT_PASS_H_
#define XLA_CLIENT_INCREASE_DYNAMISM_FOR_AUTO_JIT_PASS_H_
...
#endif  // XLA_CLIENT_INCREASE_DYNAMISM_FOR_AUTO_JIT_PASS_H_