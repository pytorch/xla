...
#ifndef XLA_CLIENT_DEVICE_COMPILATION_CLUSTER_SIGNATURE_H_
#define XLA_CLIENT_DEVICE_COMPILATION_CLUSTER_SIGNATURE_H_
...
#endif  // XLA_CLIENT_DEVICE_COMPILATION_CLUSTER_SIGNATURE_H_
