...
#ifndef XLA_CLIENT_RESOURCE_OPERATION_SAFETY_ANALYSIS_H_
#define XLA_CLIENT_RESOURCE_OPERATION_SAFETY_ANALYSIS_H_
...
#endif  // XLA_CLIENT_RESOURCE_OPERATION_SAFETY_ANALYSIS_H_