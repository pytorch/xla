...
#ifndef XLA_CLIENT_CLONE_CONSTANTS_FOR_BETTER_CLUSTERING_H_
#define XLA_CLIENT_CLONE_CONSTANTS_FOR_BETTER_CLUSTERING_H_
...
#endif  // XLA_CLIENT_CLONE_CONSTANTS_FOR_BETTER_CLUSTERING_H_