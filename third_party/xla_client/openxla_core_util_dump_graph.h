...
#ifndef XLA_CLIENT_CORE_UTIL_DUMP_GRAPH_H_
#define XLA_CLIENT_CORE_UTIL_DUMP_GRAPH_H_

#include <functional>
#include <string>

#include "third_party/xla_client/openxla_cost_graph.pb.h"
...
#endif  // XLA_CLIENT_CORE_UTIL_DUMP_GRAPH_H_