...
#ifndef XLA_CLIENT_TF_GRAPH_TO_HLO_COMPILER_H_
#define XLA_CLIENT_TF_GRAPH_TO_HLO_COMPILER_H_

#include <memory>
#include <vector>

#include "third_party/xla_client/openxla_tf_to_hlo_compiler.h"
...
#endif  // XLA_CLIENT_TF_GRAPH_TO_HLO_COMPILER_H_