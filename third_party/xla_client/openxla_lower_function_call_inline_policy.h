...
#ifndef XLA_CLIENT_LOWER_FUNCTION_CALL_INLINE_POLICY_H_
#define XLA_CLIENT_LOWER_FUNCTION_CALL_INLINE_POLICY_H_
...
#endif  // XLA_CLIENT_LOWER_FUNCTION_CALL_INLINE_POLICY_H_