...
## Adding docs
To add a new doc please create a `.md` file under `md_sources/`. To make this doc show up in our [doc pages](https://pytorch.org/xla/master/index.html), please add a `.rst` file in this directory.
