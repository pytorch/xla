...
# [Basic high-level understanding of some XLA details](#basic_ptxla)
...
![img](docs/source/_static/img/pytorchXLA_flow.pdf)
...
![img](docs/source/_static/img/IRgraph_no_markstep.png)
...
![img](docs/source/_static/img/IRgraph_markstep.png)
...
# [Converting code to PyTorch XLA](#convert_code)
...
# [Example 1. Stable Diffusion inference in PyTorch Lightning on a Single TPU Device](#example1)
...
# [Example 2. HF Stable Diffusion Inference](#example2)
...
# [Running on a Single TPU device](#single_device)
...
# [Profiling and performance analysis](#pref_analysis)
...
# [Running on Multiple TPU Devices](#multidevice)
