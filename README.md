...
notebooks](https://github.com/pytorch/xla/tree/main/contrib/kaggle) to get
started:

* [Stable Diffusion with PyTorch/XLA
  2.0](https://github.com/pytorch/xla/blob/main/contrib/kaggle/pytorch-xla-2-0-on-kaggle.ipynb)
* [Distributed PyTorch/XLA
  Basics](https://github.com/pytorch/xla/blob/main/contrib/kaggle/distributed-pytorch-xla-basics-with-pjrt.ipynb)
