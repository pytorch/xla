...
You can also add the version number and `yyyymmdd` like `torch_xla-2.8.0.devyyyymmdd`
(use the dev version on that date) to get the nightly wheel of a specified date.
Here is an example:
