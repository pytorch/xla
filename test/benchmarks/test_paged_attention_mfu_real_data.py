...
def benchmark(args):
  ...
  q_seq_lens_lst = [1248] * 94 # num_queries_per_compute_block=16 should be smaller or equal to query_len=9
  ...
  # print(f'{q.shape=}, {k_pages.shape=}, {v_pages.shape=}, {page_indices.shape=}, {kv_seq_lens=}, {effective_q_lens=}')

  profile_path = "/workspaces/persist/microbenchprofiles/plugins/profile"
  ...
  def run_benchmark(num_iters: int, profile: bool = False) -> float:
    ...
    for _ in range(num_iters):
      if args.kernel == "multi-queries-paged-attn":
        ...
        num_queries_per_compute_block=256 # constraint: due to https://github.com/jax-ml/jax/issues/24486
        num_kv_pages_per_compute_block = block_kv_size // page_size
