...
# debugging
  def test_while_loop_tpu_simple_linear(self):
    ...
    def body_fn(upper, lower, one_value, x, input_value, weight_0, bias_0, output_value):
      ...
      return upper.clone(), new_lower.clone(), one_value.clone(), torch.add(one_value, x), input_value.clone(), weight.clone(), bias.clone(), output_value_real
    ...
    upper__, lower__, one_value__, torch_add_res__, input_value__, output_value_real__, weight__, bias__ = while_loop( cond_fn, body_fn, (upper, lower, one_value, init_val, l_in_0, output_value, weight_0, bias_0))
