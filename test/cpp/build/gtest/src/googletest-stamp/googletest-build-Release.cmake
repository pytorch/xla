...
set(stdout_log "/private/home/mruberry/xla/pytorch/xla/test/cpp/build/gtest/src/googletest-stamp/googletest-build-out.log")
set(stderr_log "/private/home/mruberry/xla/pytorch/xla/test/cpp/build/gtest/src/googletest-stamp/googletest-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /private/home/mruberry/xla/pytorch/xla/test/cpp/build/gtest/src/googletest-stamp/googletest-build-*.log")
  endif()
  ...
  set(msg "googletest build command succeeded.  See also /private/home/mruberry/xla/pytorch/xla/test/cpp/build/gtest/src/googletest-stamp/googletest-build-*.log")
  message(STATUS "${msg}")
endif()
