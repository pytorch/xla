...
TEST_F(XLAGeneratorTest, Seed) {
    ...
    // The new seed should be different from the old one and set as the current seed
...
TEST_F(XLAGeneratorTest, Clone) {
    ...
    // Verify that the cloned generator has the same state but is a different object
