...
def wrap_optimizer_with_scheduler(optimizer, flags, num_steps_per_epoch=None,
                                  summary_writer=None):
  ...
  Raises:
    ValueError if the requested scheduler_type is invalid.
  """
