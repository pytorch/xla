...
xla::XlaOp PadInputFromOutputSize(xla::XlaOp input,
  ...
  return compiler::PadToSize(input, expected_input_sizes);
}
...
xla::XlaOp BuildConvBackwardInput(xla::XlaOp grad_output, xla::XlaOp kernel,
  ...
  xla::PrecisionConfig precision_config =
      compiler::XlaHelpers::BuildPrecisionConfig(
          compiler::XlaHelpers::mat_mul_precision());
...
xla::XlaOp BuildTransposedConvolution(
  ...
  const xla::Shape& input_shape = compiler::XlaHelpers::ShapeOfXlaOp(input);
  const xla::Shape& kernel_shape = compiler::XlaHelpers::ShapeOfXlaOp(kernel);
  xla::int64 num_spatial = input_shape.rank() - 2;
...
ConvGrads BuildTransposedConvolutionBackward(
  ...
  xla::XlaOp grad_weight = BuildConvBackwardWeight(
      padded_input, grad_output, compiler::XlaHelpers::ShapeOfXlaOp(kernel),
...
xla::XlaOp BuildConvolutionOverrideableBias(
  ...
  auto broadcast_sizes = compiler::XlaHelpers::SizesOfXlaOp(conv);
...
ConvGrads BuildConvolutionBackwardOverrideable(
  ...
  if (transposed) {
    ...
    xla::XlaOp grad_input = BuildConvBackwardInput(
        grad_output, kernel, compiler::XlaHelpers::ShapeOfXlaOp(input), stride,
        padding, dilation, groups);
    xla::XlaOp grad_weight = BuildConvBackwardWeight(
        grad_output, input, compiler::XlaHelpers::ShapeOfXlaOp(kernel), stride,
        padding, dilation, groups);
    xla::XlaOp grad_bias = BuildGradBias(grad_output);
