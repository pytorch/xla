...
xla::XlaOp MakeSeed(xla::XlaOp seed) {
  const xla::Shape& rng_shape = compiler::XlaHelpers::ShapeOfXlaOp(seed);
...
xla::XlaOp MakeUniformBoundaryValue(xla::XlaOp val) {
  xla::PrimitiveType element_type = compiler::XlaHelpers::TypeOfXlaOp(val);
...
xla::XlaOp RngDiscreteUniform(xla::XlaOp seed, const xla::Shape& shape,
  ...
  xla::PrimitiveType minval_type = compiler::XlaHelpers::TypeOfXlaOp(minval);
  xla::PrimitiveType maxval_type = compiler::XlaHelpers::TypeOfXlaOp(maxval);
...
xla::XlaOp RngUniform(xla::XlaOp seed, const xla::Shape& shape,
  ...
  switch (shape.element_type()) {
    ...
    case xla::PrimitiveType::C128: {
      xla::XlaOp k_seed = compiler::XlaHelpers::ScalarValue<xla::uint64>(
          17, compiler::XlaHelpers::TypeOfXlaOp(rng_seed), rng_seed.builder());
    ...
    case xla::PrimitiveType::F64: {
      xla::XlaOp rng =
          xla::NormalFloatingPointDistribution(rng_seed, initial_state,
                                               GetBitGenerator(), rng_shape)
              .value;
      return compiler::XlaHelpers::PromotedAdd(
          mean, compiler::XlaHelpers::PromotedMul(rng, std));
    }
    case xla::PrimitiveType::C64:
    case xla::PrimitiveType::C128: {
      xla::XlaOp k_seed = compiler::XlaHelpers::ScalarValue<xla::uint64>(
      ...
      xla::XlaOp sqrtTwo = compiler::XlaHelpers::ScalarValue(
          std::sqrt(2), compiler::XlaHelpers::TypeOfXlaOp(std),
          rng_seed.builder());
      return compiler::XlaHelpers::PromotedAdd(
          mean, compiler::XlaHelpers::PromotedMul(rng, std / sqrtTwo));
    }
    default:
