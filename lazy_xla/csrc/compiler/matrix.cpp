...
DiagonalMask CreateDiagonalMask(xla::XlaOp input,
  ...
  xla::XlaOp empty_mask = compiler::XlaHelpers::ScalarBroadcast(
      true, xla::PrimitiveType::PRED, input_shape.dimensions(),
      input.builder());
  xla::XlaOp mask =
...
xla::XlaOp BuildDiagonalViewUpdate(xla::XlaOp target, xla::XlaOp input,
  ...
  if (dim1 != 0 || dim2 != 1) {
    ...
    target_shape = &compiler::XlaHelpers::ShapeOfXlaOp(diag_target);
  }
