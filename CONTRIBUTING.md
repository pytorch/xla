...
* Since you are running as root in this container, teach `git` to recognize the repositories you
  just cloned (outside of docker) as safe:
...
* Build PyTorch, TorchVision, and PyTorch/XLA:
  ...
  cd pytorch/xla
  pip install -e .
  # Optional: if you're using TPU, install TPU extras
