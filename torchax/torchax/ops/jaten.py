...
def _aten_upsample_bilinear2d(x,
                              output_size,
                              align_corners=False,
                              scale_h=None,
                              scale_w=None):
  return _aten_upsample_bilinear2d_aa(
      x,
...
def _aten_max_pool2d_with_indices(inputs,
  ...
  y = jax.lax.reduce_window(inputs, init_val, jax.lax.max, dims, strides,
                            padding)
  indices, _ = jax.lax.reduce_window((indices, inputs), (0, init_val),
